...
class Plugins extends ReportWidgetBase
{
    ...
    protected function loadData()
    {
        ...
        $this->vars['js'] = DB::table('frontend_plugins')->where('language', '1')->count();
        $this->vars['php'] = DB::table('frontend_plugins')->where('language', '2')->count();
        $this->vars['css'] = DB::table('frontend_plugins')->where('language', '3')->count();
    }
}
